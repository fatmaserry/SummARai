...
export default function Profile() {
  ...
  return (
    <>
      {/* IMPORTANT for direction of tracking calender */}
      <style> {`.react-activity-calendar { direction: ltr !important; }`} </style>
      ...
      <div className=" text-white min-h-screen p-6 flex flex-col  space-y-8">
        ...
        <div className="flex  w-full max-w-md items-center ">
          <div className="w-24 h-24 rounded-full flex items-center justify-center relative">
            <div
              ...
              className="group cursor-pointer absolute -bottom-1 -left-1 z-10 flex items-center justify-center"
            >
              <EditIcon size={30} />
            </div>
        ...
        <div className="mb-8 w-full relative">
          ...
          {activityData.length > 0 ? (
            <div className="ltr-calendar-wrapper w-full bg-[#1C1F36] p-6 rounded-lg flex justify-center items-center">
              <ActivityCalendar
                data={activityData}
                blockSize={14}
                blockMargin={4}
                ...
                labels={{
                  ...
                  weekdays: ["الإثنين", "الأحد", "السبت", "الجمعة", "الخميس", "الأربعاء", "الثلاثاء"],
